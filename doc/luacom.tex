...
\subsection*{Version 1.4beta}

\begin{itemize}

\item Formally support Lua 5.1 (Lua 4.0/5.0 support will be dropped).

\item Building with MSVC++2005.  Both Makefile and Visual Studio
.sln/.vcproj files available.

\item Fixed handling of empty SafeArrays and SafeArrays of one dimension.

\item Fixed reversed order of indices in multidimensional SafeArray's

\item Fixed handling BSTR's with embedded zeros. Bug#428.
