$(SRC_LIB_DIR)\luacom5.loh : $(SRC_LIB_DIR)\luacom5.lua
...
$(OBJ_DIR)/tLuaCOM.obj : $(SRC_LIB_DIR)/luacom5.loh $(SRC_LIB_DIR)/tLuaCOM.cpp $(SRC_LIB_DIR)/tLuaCOM.h $(SRC_LIB_DIR)/tLuaDispatch.h $(SRC_LIB_DIR)/LuaAux.h $(SRC_LIB_DIR)/tUtil.h $(SRC_LIB_DIR)/tLuaCOMException.h $(SRC_LIB_DIR)/tCOMUtil.h $(SRC_LIB_DIR)/LuaCompat.h
...
$(OBJ_DIR)/luacom.obj : $(SRC_LIB_DIR)/luacom5.loh $(SRC_LIB_DIR)/luacom.cpp $(INC_DIR)/luacom.h $(SRC_LIB_DIR)/luabeans.h $(SRC_LIB_DIR)/tLuaDispatch.h $(SRC_LIB_DIR)/tLuaCOM.h $(SRC_LIB_DIR)/tLuaCOMException.h $(SRC_LIB_DIR)/LuaAux.h $(SRC_LIB_DIR)/tUtil.h $(SRC_LIB_DIR)/LuaCompat.h $(SRC_LIB_DIR)/tLuaCOMEnumerator.h $(LUACOM_LUA) $(SRC_LIB_DIR)/tCOMUtil.h $(SRC_LIB_DIR)/tLuaCOMClassFactory.h $(SRC_LIB_DIR)/tLuaCOMTypeHandler.h $(SRC_LIB_DIR)/tLuaCOMConnPoints.h $(SRC_LIB_DIR)/luacom_internal.h $(SRC_LIB_DIR)/tLuaTLB.h
